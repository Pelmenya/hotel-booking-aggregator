...
import { CreateHotelDto } from 'src/modules/hotels-mongo/types/create-hotel.dto';
import { HotelData } from 'src/modules/hotels-mongo/types/hotel-data';
...
import { THotelDataRes } from 'src/modules/hotels-mongo/types/t-hotel-data-res';
...
export interface IAdminService {
    ...
    getHotelsMongo(query: SearchBaseParams): Promise<HotelData[]>;
    createHotel(
